...
# MAGIC - **Standard**: `spark_version: "18.2.x-scala2.13"` + `runtime_engine: "STANDARD"`
# MAGIC - **Photon**: `spark_version: "18.2.x-scala2.13"` + `runtime_engine: "PHOTON"`
...
# Valhalla Init Script for DBR 18.2+
